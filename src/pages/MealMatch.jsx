...
const MealMatch = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 flex flex-col items-center">
        <style>
          {`
            @keyframes slide-in {
        ...
        <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-10 flex flex-col items-center">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-600 via-red-500 to-orange-700 bg-clip-text text-transparent mb-5">
